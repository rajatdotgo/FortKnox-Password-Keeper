...
public final class upi
{
    ...
    private final String tableName = "upitable";
    private final String primarykey = "upiId";
    ...
    public upi(String bankName, String upiId,String pass, String comment) throws Exception
    {
        /* 
      ...
      */
      this.addMember(bankName, upiId, pass, comment);
     ...
     public void addDataToDataBase()throws Exception
    {
        ...
        sql=" insert into "+this.tableName+" (BankName,UpiId, Password, Comment, Hash)" + " values (?,?,?,?,?)";
        pst=conn.prepareStatement(sql);
        pst.setString(1,this.bankName);
        pst.setString(2, this.upiId);
    ...
    public void addMember(String bankName, String upiId,  String pass, String comment) throws Exception
    {   
        this.bankName = bankName;
        this.upiId  = upiId;
        
        this.comment = comment;
        this.hash = hashing.createHashOfTwoString(this.bankName, this.upiId);
