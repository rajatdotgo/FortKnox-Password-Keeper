...
public final class Email 
{
    ...
    private final String primarykey = "Email";
    ...
    public Email(String pName, String eAdd, String pass, String comment) throws Exception
    {
        /* 
     ...
     public void addDataToDataBase()throws Exception
    {
        ...
        sql=" insert into "+this.tableName+" (Provider ,Email,Password, Comment, Hash)" + " values (?,?,?,?,?)";
