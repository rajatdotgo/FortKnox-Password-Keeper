...
public final class netBanking
{
    ...
    private final String tableName = "netbankingtable";
    ...
    public netBanking(String bankName, String userName,String pass, String comment) throws Exception
    {
        /* 
      ...
      */
      this.addMember(bankName, userName, pass, comment);
     ...
     public void addDataToDataBase()throws Exception
    {
        ...
        sql=" insert into "+this.tableName+" (BankName,UserName, Password, Comment, Hash)" + " values (?,?,?,?,?)";
    ...
    public void addMember(String bankName, String userName,  String pass, String comment) throws Exception
    {   
        this.bankName = bankName;
        this.userName  = userName;
        
        this.comment = comment;
        this.hash = hashing.createHashOfTwoString(this.bankName, this.userName);
